...
public enum RoomConfigCode {
    ...
    CREATE_ROOM_SUCCESS("대기방 생성 성공", HttpStatus.CREATED),
    CREATE_ROOM_FAIL("대기방 생성 실패", HttpStatus.BAD_REQUEST),
    ENTER_ROOM_SUCCESS("대기방 입장 성공", HttpStatus.OK),
    LEAVE_ROOM_SUCCESS("대기방 퇴장", HttpStatus.OK),
    GET_ROOM_LIST_SUCCESS("대기방 목록 조회 성공", HttpStatus.OK),
    START_GAME_SUCCESS("게임 시작 성공", HttpStatus.OK),
    LEAVE_GAME_SUCCESS("게임 퇴장 성공", HttpStatus.OK),
    END_GAME_SUCCESS("게임 종료 성공", HttpStatus.OK),
